...
icon = pygame.image.load('pong_window_image.png')
pygame.display.set_icon(icon)

#Player
player_img = pygame.image.load('pong_paddle.png')
player_X = 10
...
#Cpu
cpu_img = pygame.image.load('pong_paddle.png')
cpu_X = width - 10 - 27
cpu_Y = height/2 -100

#functions
def player(y_val):
    display.blit(player_img, (player_X, y_val))

def ball():
    display.blit(ball_img, (ball_X, ball_Y))

def cpu():
    display.blit(cpu_img, (cpu_X, cpu_Y))
